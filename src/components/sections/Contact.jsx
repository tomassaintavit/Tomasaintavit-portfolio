...
export const Contact = () => {
    ...
    const handleSubmit = (e) => {
        ...
        emailjs
          ...
          .catch(() => alert("Oops! Algo salio mal. Por favor intente nuevamente."));
      };
        ...
        >
            <RevealOnScroll>
                <div className="px-4 w-150">
                    <h2 className="text-3xl font-bold mb-8 bg-gradient-to-r from-blue-500 to-green-500 bg-clip-text text-transparent text-center"> Contáctame</h2>
